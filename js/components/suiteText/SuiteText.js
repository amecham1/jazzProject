  ...
  render () {
    return (
      <div className='suite-text-container'>
        ...
        <p className='suite-paragraph first-suite-paragraph'>Welcome to the very best Utah Sports and Entertainment has to offer - Vivint Smart Home Arena Luxury Suites. Whether, you are entertaining business clients, closing a major deal or socializing with family and friends, a Luxury Suite provides all the convienece, comfort and service you desire. Home to the Utah Jazz and the most popular musical acts and family shows - Vivint Smart Home Arena is the place to meet, greet, see and be seen in Utah.</p>
        <h3 className='title-suite-text'>WHY BE A LUXURY SUITE HOLDER?</h3>
        <p className='suite-paragraph'>Your suite can enance your corporate profile and give you an advantage over your competitors. It offers the chance to communicate your message in a luxurios setting while making entertaining as easy as it is elegant. Be a part of the most unique and exciting way to entertain in Utah by becoming an Vivint Smart Arena Luxury Suite holder.</p>
