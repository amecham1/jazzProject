    ...
    return (
      <div className='executive-photo-container'>
        ...
        <div className='executive-photo-bottom'>
          <img className='executive-group-photo executive-placement-left' src='js/img/executivePhotos/Restaurant-Interior.jpg' alt='photo of buffet selection' />
          <img className='executive-group-photo executive-placement-right' src='js/img/executivePhotos/Salad-Mix.jpg' alt='interior of empty luxury suite' />
        </div>
      </div>
    )
  }
